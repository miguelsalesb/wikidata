...
# that is why the get_wikidata_id function has a articles parameter
    ...
    if len(js['results']['bindings']) > 0:
        ...
        for data in js['results']['bindings']:
            ...
            for key, values in data.items():
                if key == 'authorDescription':
                    wikidata_author_description = data['authorDescription']['value']
        ...
        # print("wikidata_author_description: ", wikidata_author_description)
        return {"wikidata_author_library_id": wikidata_author_library_id,
                "wikidata_author_description": wikidata_author_description, 
                "wikidata_author_birth_date": wikidata_author_birth_date, 
                "wikidata_author_death_date": wikidata_author_death_date,
                "wikidata_author_occupations": wikidata_author_occupations,
                "wikidata_author_notable_work": wikidata_author_notable_work
                }
